...
--- GNUmakefile.in	12 Apr 2006 07:22:57 -0000
*************** html_manuals :=
*** 153,161 ****
--- 153,163 ----
  subdirs := \
...
+ 
+ hpec_cxx_sources := $(wildcard $(srcdir)/benchmarks/hpec-kernel/*.cpp)
...
+                                $(hpec_cxx_sources))
+ 
+ hpec_cxx_exes_special   := benchmarks/hpec-kernel/main$(EXEEXT)
...
+   %.$(OBJEXT) benchmarks/hpec-kernel/main.$(OBJEXT) src/vsip/libvsip.a
+ 	$(CXX) $(LDFLAGS) -o $@ $^ $(LIBS) || rm -f $@
Index: benchmarks/hpec-kernel/firbank.cpp
===================================================================
RCS file: benchmarks/hpec-kernel/firbank.cpp
diff -N benchmarks/hpec-kernel/firbank.cpp
*** /dev/null	1 Jan 1970 00:00:00 -0000
--- benchmarks/hpec-kernel/firbank.cpp	12 Apr 2006 07:22:58 -0000
***************
*** 0 ****
--- 1,489 ----
+ /* Copyright (c) 2006 by CodeSourcery.  All rights reserved. */
...
+ }
+  
Index: benchmarks/hpec-kernel/make.standalone
===================================================================
RCS file: benchmarks/hpec-kernel/make.standalone
diff -N benchmarks/hpec-kernel/make.standalone
*** /dev/null	1 Jan 1970 00:00:00 -0000
--- benchmarks/hpec-kernel/make.standalone	12 Apr 2006 07:22:58 -0000
***************
*** 0 ****
--- 1,42 ----
+ ######################################################### -*-Makefile-*-
+ #
+ # File:   share/sourceryvsipl++/benchmarks/hpec-kernel/Makefile
+ # Author: Don McCoy
+ # Date:   2006-01-18
+ #
