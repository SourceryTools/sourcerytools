Index: src/matlab_text_formatter.cpp
===================================================================
--- src/matlab_text_formatter.cpp	(revision 0)
+++ src/matlab_text_formatter.cpp	(revision 0)
@@ -0,0 +1,16 @@
+
...
+
Index: src/matlab_bin_formatter.cpp
===================================================================
--- src/matlab_bin_formatter.cpp	(revision 0)
+++ src/matlab_bin_formatter.cpp	(revision 0)
@@ -0,0 +1,34 @@
+
+  {
...
+  }
+
Index: src/matlab_iter_example1.cpp
===================================================================
--- src/matlab_iter_example1.cpp	(revision 0)
+++ src/matlab_iter_example1.cpp	(revision 0)
@@ -0,0 +1,18 @@
+
...
+  }
+
Index: src/matlab_iter_example2.cpp
===================================================================
--- src/matlab_iter_example2.cpp	(revision 0)
+++ src/matlab_iter_example2.cpp	(revision 0)
@@ -0,0 +1,22 @@
+
+  Matlab_file mf("temp.mat");
...
Index: api.xml
===================================================================
--- api.xml	(revision 149101)
+++ api.xml	(working copy)
@@ -163,4 +163,118 @@
