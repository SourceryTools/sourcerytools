...
===================================================================
--- benchmarks/hpec_kernel/cfar.cpp	(revision 170082)
...
===================================================================
--- benchmarks/hpec_kernel/firbank.cpp	(revision 170082)
...
+struct t_firbank_base<T, ImplFast> : public t_local_view<T>, Benchmark_base
 {
...
+template <typename T>
+struct t_firbank_base<T, ImplExpr> : public t_local_view<T>, Benchmark_base
+{
+  float fft_ops(length_type len)
+  {
...
+    
+    for_fftm_type for_fftm(Domain<2>(local_M, N), scale);
+    inv_fftm_type inv_fftm(Domain<2>(local_M, N), scale / float(N));
+
...
+    {
+      LOCAL(outputs) = inv_fftm(response * for_fftm(LOCAL(inputs)));
+    }
+    t1.stop();
+    time = t1.delta();
+
...
===================================================================
--- benchmarks/hpec_kernel/svd.cpp	(revision 170082)
...
===================================================================
--- benchmarks/hpec_kernel/cfar_c.cpp	(revision 170082)
