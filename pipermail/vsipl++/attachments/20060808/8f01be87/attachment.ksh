...
Index: benchmarks/alltoall_mpi.cpp
===================================================================
--- benchmarks/alltoall_mpi.cpp	(revision 146503)
+++ benchmarks/alltoall_mpi.cpp	(working copy)
@@ -1,6 +1,6 @@
...
Index: benchmarks/copy_mpi.cpp
===================================================================
--- benchmarks/copy_mpi.cpp	(revision 0)
+++ benchmarks/copy_mpi.cpp	(revision 0)
@@ -0,0 +1,632 @@
...
+    @author  Jules Bergmann
+    @date    2006-07-23
+    @brief   VSIPL++ Library: Benchmark for MPI point-to-point messaging.
+                              (aka "copy").
+*/
+
+/***********************************************************************
...
===================================================================
--- benchmarks/mpi_alltoall.cpp	(revision 146503)
