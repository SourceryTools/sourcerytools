...
vendor_CBLAS           := vendor/atlas/lib/libcblas.a
vendor_ATLAS           := vendor/atlas/lib/libatlas.a
vendor_ATLAS_LIBS      := $(vendor_ATLAS) \
                          $(vendor_CBLAS) \
                          $(vendor_F77BLAS) \
                          $(vendor_PRE_LAPACK)
...
install:: $(vendor_F77BLAS)
	$(INSTALL_DATA) $(vendor_F77BLAS) $(DESTDIR)$(libdir)
endif

ifdef USE_ATLAS_LAPACK
install:: $(vendor_ATLAS) $(vendor_CBLAS) $(vendor_LAPACK)
	$(INSTALL_DATA) $(vendor_ATLAS)    $(DESTDIR)$(libdir)
	$(INSTALL_DATA) $(vendor_CBLAS)    $(DESTDIR)$(libdir)
	$(INSTALL_DATA) $(vendor_LAPACK)   $(DESTDIR)$(libdir)
