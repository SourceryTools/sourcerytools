...
+++ GNUmakefile.inc.in	23 May 2006 18:56:09 -0000
@@ -12,13 +12,59 @@
 # Variables
 ########################################################################
...
+++ matlab.hpp	23 May 2006 18:56:09 -0000
@@ -0,0 +1,85 @@
...
--- /dev/null	1 Jan 1970 00:00:00 -0000
+++ matlab_bin_formatter.hpp	23 May 2006 18:56:09 -0000
@@ -0,0 +1,232 @@
...
+
+
+// operators to write when non-constant Matrix and Vector are passed
+template <typename T,
+          typename Block0>
+inline
+std::ostream&
...
--- /dev/null	1 Jan 1970 00:00:00 -0000
+++ matlab_text_formatter.hpp	23 May 2006 18:56:09 -0000
@@ -0,0 +1,91 @@
+/* Copyright (c) 2005, 2006 by CodeSourcery.  All rights reserved. */
+
...
+++ output.hpp	23 May 2006 18:56:09 -0000
@@ -17,9 +17,6 @@
