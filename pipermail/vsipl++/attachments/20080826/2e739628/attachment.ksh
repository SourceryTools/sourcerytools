...
Index: tests/coverage_binary_mul_vi.cpp
===================================================================
--- tests/coverage_binary_mul_vi.cpp	(revision 0)
+++ tests/coverage_binary_mul_vi.cpp	(revision 0)
@@ -0,0 +1,55 @@
...
+  return EXIT_SUCCESS;
+}
Index: tests/extdata_subviews_t.cpp
===================================================================
--- tests/extdata_subviews_t.cpp	(revision 0)
+++ tests/extdata_subviews_t.cpp	(revision 0)
@@ -0,0 +1,78 @@
...
+  return 0;
+}
Index: tests/extdata_subviews_v.cpp
===================================================================
--- tests/extdata_subviews_v.cpp	(revision 0)
+++ tests/extdata_subviews_v.cpp	(revision 0)
@@ -0,0 +1,95 @@
+/* Copyright (c) 2005, 2006, 2008 by CodeSourcery.  All rights reserved.
+
...
===================================================================
--- tests/coverage_binary_mul_m.cpp	(revision 0)
+++ tests/coverage_binary_mul_m.cpp	(revision 0)
@@ -0,0 +1,56 @@
+/* Copyright (c) 2005, 2006, 2007 by CodeSourcery.  All rights reserved.
+
...
===================================================================
--- tests/extdata-subviews.cpp	(revision 218695)
...
-
-  typedef typename vsip::impl::Ext_data<subblock_type>::storage_type storage_type;
-  typedef typename storage_type::type                          ptr_type;
-
-  view = T();
-
-  test_assert(vsip::impl::Ext_data_cost<BlockT>::value == 0);
-  test_assert(vsip::impl::Ext_data_cost<subblock_type>::value == 0);
-
-  subview_type subv = view(subdom);
-
-  {
-    vsip::impl::Ext_data<subblock_type> ext(subv.block());
-
...
-
-  test_assert(vsip::impl::Ext_data_cost<BlockT>::value == 0);
-  test_assert(vsip::impl::Ext_data_cost<realblock_type>::value == 0);
-  test_assert(vsip::impl::Ext_data_cost<imagblock_type>::value == 0);
-
...
-  {
-    vsip::impl::Ext_data<realblock_type> ext(real.block());
-
-    // This should be direct access
-    test_assert(ext.CT_Cost         == 0);
-    test_assert(ext.CT_Mem_not_req  == true);
...
-  {
-    vsip::impl::Ext_data<imagblock_type> ext(imag.block());
-
-    // This should be direct access
-    test_assert(ext.CT_Cost         == 0);
-    test_assert(ext.CT_Mem_not_req  == true);
...
-  {
-    vsip::impl::Ext_data<realblock_type> rext(real.block());
-    vsip::impl::Ext_data<imagblock_type> iext(imag.block());
-
...
-  typedef typename vsip::impl::Ext_data<row_block_type>::raw_ptr_type raw_ptr_type;
-  typedef typename vsip::impl::Ext_data<row_block_type>::storage_type storage_type;
-
...
-
-  test_assert(vsip::impl::Ext_data_cost<BlockT>::value == 0);
-  test_assert(vsip::impl::Ext_data_cost<row_block_type>::value == 0);
-
...
-
-    {
-      vsip::impl::Ext_data<row_block_type> ext(row.block());
-
-      test_assert(ext.CT_Cost         == 0);
-      test_assert(ext.CT_Mem_not_req  == true);
-      test_assert(ext.CT_Xfer_not_req == true);
...
-  typedef typename vsip::impl::Ext_data<col_block_type>::raw_ptr_type raw_ptr_type;
-  typedef typename vsip::impl::Ext_data<col_block_type>::storage_type storage_type;
-
-  length_type rows = mat.size(0);
-  length_type cols = mat.size(1);
-
...
-
-  test_assert(vsip::impl::Ext_data_cost<BlockT>::value == 0);
-  test_assert(vsip::impl::Ext_data_cost<col_block_type>::value == 0);
-
...
-
-    {
-      vsip::impl::Ext_data<col_block_type> ext(col.block());
-
-      test_assert(ext.CT_Cost         == 0);
-      test_assert(ext.CT_Mem_not_req  == true);
-      test_assert(ext.CT_Xfer_not_req == true);
...
-  typedef typename vsip::impl::Ext_data<subblock_type>::raw_ptr_type raw_ptr_type;
-  typedef typename vsip::impl::Ext_data<subblock_type>::storage_type storage_type;
-
-  length_type rows = mat.size(0);
-  length_type cols = mat.size(1);
...
-      vsip::impl::Ext_data<subblock_type> ext(diagv.block());
-
-      raw_ptr_type ptr = ext.data();
...
-
-  typedef typename Tensor<T, BlockT>::template subvector<D1, D2>::impl_type
-    subv_type;
-
-  
...
-  typedef typename vsip::impl::Ext_data<subv_block_type>::raw_ptr_type raw_ptr_type;
-  typedef typename vsip::impl::Ext_data<subv_block_type>::storage_type storage_type;
-
...
-
-    {
-      vsip::impl::Ext_data<subv_block_type> ext(subv.block());
-
-      test_assert(ext.CT_Cost         == 0);
-      test_assert(ext.CT_Mem_not_req  == true);
-      test_assert(ext.CT_Xfer_not_req == true);
...
===================================================================
--- tests/coverage_binary_mul.cpp	(revision 218695)
+++ tests/coverage_binary_mul.cpp	(working copy)
@@ -1,73 +0,0 @@
-/* Copyright (c) 2005, 2006, 2007 by CodeSourcery.  All rights reserved.
-
-   This file is available for license from CodeSourcery, Inc. under the terms
...
-  return EXIT_SUCCESS;
-}
Index: tests/coverage_binary_mul_vd.cpp
===================================================================
--- tests/coverage_binary_mul_vd.cpp	(revision 0)
+++ tests/coverage_binary_mul_vd.cpp	(revision 0)
@@ -0,0 +1,58 @@
+/* Copyright (c) 2005, 2006, 2007 by CodeSourcery.  All rights reserved.
+
...
+  return EXIT_SUCCESS;
+}
Index: tests/coverage_binary_mul_vf.cpp
===================================================================
--- tests/coverage_binary_mul_vf.cpp	(revision 0)
+++ tests/coverage_binary_mul_vf.cpp	(revision 0)
@@ -0,0 +1,58 @@
+/* Copyright (c) 2005, 2006, 2007 by CodeSourcery.  All rights reserved.
+
...
+  return EXIT_SUCCESS;
+}
Index: tests/extdata-subviews.hpp
===================================================================
--- tests/extdata-subviews.hpp	(revision 218695)
+++ tests/extdata-subviews.hpp	(working copy)
@@ -4,12 +4,15 @@
    of a commercial license and under the GPL.  It is not part of the VSIPL++
    reference implementation and is not available under the BSD license.
 */
...
Index: tests/extdata_subviews_m.cpp
===================================================================
--- tests/extdata_subviews_m.cpp	(revision 0)
+++ tests/extdata_subviews_m.cpp	(revision 0)
@@ -0,0 +1,78 @@
+/* Copyright (c) 2005, 2006, 2008 by CodeSourcery.  All rights reserved.
+
