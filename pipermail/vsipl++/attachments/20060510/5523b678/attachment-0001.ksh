...
--- doc/quickstart/quickstart.xml	11 May 2006 04:50:42 -0000
***************
*** 742,759 ****
       </varlistentry>
...
!         of ATLAS/F77-LAPACK to perform linear algebra.  Like 
!         <option>builtin</option>, this option requires building ATLAS.
!         In this case, it uses the FORTRAN version instead of the C 
!         version of LAPACK.  Note this option requires a fortran compiler
