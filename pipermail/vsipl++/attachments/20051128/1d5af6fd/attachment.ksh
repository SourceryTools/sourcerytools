...
--- ChangeLog	28 Nov 2005 16:33:45 -0000
***************
*** 1,3 ****
--- 1,10 ----
...
--- configure.ac	28 Nov 2005 16:33:46 -0000
*************** AC_INIT(VSIPL++, 1.0, vsipl++@codesource
*** 18,28 ****
  #
  AC_ARG_WITH(obj_ext,
...
!                  [Specify the file extension to be used for executable files.]),
    [exe_ext=$withval])
...
--- src/vsip/impl/extdata.hpp	28 Nov 2005 16:33:46 -0000
