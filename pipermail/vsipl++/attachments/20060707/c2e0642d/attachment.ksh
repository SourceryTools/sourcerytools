...
+++ matlab.hpp	7 Jul 2006 04:20:17 -0000
@@ -0,0 +1,302 @@
...
--- /dev/null	1 Jan 1970 00:00:00 -0000
+++ matlab_bin_formatter.hpp	7 Jul 2006 04:20:17 -0000
@@ -0,0 +1,394 @@
...
--- /dev/null	1 Jan 1970 00:00:00 -0000
+++ matlab_text_formatter.hpp	7 Jul 2006 04:20:17 -0000
@@ -0,0 +1,91 @@
+/* Copyright (c) 2005, 2006 by CodeSourcery.  All rights reserved. */
+
...
Index: output.hpp
===================================================================
RCS file: /home/cvs.old/Repository/vpp/src/vsip_csl/output.hpp,v
retrieving revision 1.2
diff -u -r1.2 output.hpp
--- output.hpp	25 May 2006 19:06:49 -0000	1.2
+++ output.hpp	7 Jul 2006 04:20:17 -0000
@@ -114,6 +114,6 @@
   return out;
 }
