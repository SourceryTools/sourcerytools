...
+
+#if 0
+      __vector __bool short vec_s01_good = vec_pack(vec_0_good, vec_1_good);
+      __vector __bool short vec_s23_good = vec_pack(vec_2_good, vec_3_good);
+      __vector __bool char  vec_good     = vec_pack(vec_s01_good, vec_s23_good);
+#else
+      us_simd_t vec_s01_good = ui_simd::pack(vec_0_good, vec_1_good);
+      us_simd_t vec_s23_good = ui_simd::pack(vec_2_good, vec_3_good);
+      sc_simd_t vec_good     = (sc_simd_t)us_simd::pack(vec_s01_good, vec_s23_good);
+#endif
+
...
+
+      si_simd_t vec_0_k00= simd::convert_sint<15>(simd::fma(vec_u0_1_beta, vec_v0_1_beta, vec_05));
+      si_simd_t vec_1_k00= simd::convert_sint<15>(simd::fma(vec_u1_1_beta, vec_v1_1_beta, vec_05));
+      si_simd_t vec_2_k00= simd::convert_sint<15>(simd::fma(vec_u2_1_beta, vec_v2_1_beta, vec_05));
+      si_simd_t vec_3_k00= simd::convert_sint<15>(simd::fma(vec_u3_1_beta, vec_v3_1_beta, vec_05));
+      si_simd_t vec_0_k01= simd::convert_sint<15>(simd::fma(vec_u0_beta,   vec_v0_1_beta, vec_05));
+      si_simd_t vec_1_k01= simd::convert_sint<15>(simd::fma(vec_u1_beta,   vec_v1_1_beta, vec_05));
+      si_simd_t vec_2_k01= simd::convert_sint<15>(simd::fma(vec_u2_beta,   vec_v2_1_beta, vec_05));
+      si_simd_t vec_3_k01= simd::convert_sint<15>(simd::fma(vec_u3_beta,   vec_v3_1_beta, vec_05));
+      si_simd_t vec_0_k10= simd::convert_sint<15>(simd::fma(vec_u0_1_beta, vec_v0_beta, vec_05));
+      si_simd_t vec_1_k10= simd::convert_sint<15>(simd::fma(vec_u1_1_beta, vec_v1_beta, vec_05));
+      si_simd_t vec_2_k10= simd::convert_sint<15>(simd::fma(vec_u2_1_beta, vec_v2_beta, vec_05));
+      si_simd_t vec_3_k10= simd::convert_sint<15>(simd::fma(vec_u3_1_beta, vec_v3_beta, vec_05));
+      si_simd_t vec_0_k11= simd::convert_sint<15>(simd::fma(vec_u0_beta,   vec_v0_beta, vec_05));
+      si_simd_t vec_1_k11= simd::convert_sint<15>(simd::fma(vec_u1_beta,   vec_v1_beta, vec_05));
+      si_simd_t vec_2_k11= simd::convert_sint<15>(simd::fma(vec_u2_beta,   vec_v2_beta, vec_05));
+      si_simd_t vec_3_k11= simd::convert_sint<15>(simd::fma(vec_u3_beta,   vec_v3_beta, vec_05));
+
...
+
+#if 0
+      ui_simd_t vec_0_offset_row = ui_simd::add(vec_0_offset, vec_in_stride_0);
+      ui_simd_t vec_1_offset_row = ui_simd::add(vec_1_offset, vec_in_stride_0);
+      ui_simd_t vec_2_offset_row = ui_simd::add(vec_2_offset, vec_in_stride_0);
+      ui_simd_t vec_3_offset_row = ui_simd::add(vec_3_offset, vec_in_stride_0);
+
...
+
+      unsigned int off_00_row, off_01_row, off_02_row, off_03_row;
+      unsigned int off_10_row, off_11_row, off_12_row, off_13_row;
+      unsigned int off_20_row, off_21_row, off_22_row, off_23_row;
+      unsigned int off_30_row, off_31_row, off_32_row, off_33_row;
+
...
+
+      ui_simd::extract_all(vec_0_offset_row, off_00_row, off_01_row,
+			                     off_02_row, off_03_row);
+      ui_simd::extract_all(vec_1_offset_row, off_10_row, off_11_row,
+			                     off_12_row, off_13_row);
+      ui_simd::extract_all(vec_2_offset_row, off_20_row, off_21_row,
+			                     off_22_row, off_23_row);
+      ui_simd::extract_all(vec_3_offset_row, off_30_row, off_31_row,
+			                     off_32_row, off_33_row);
+
+      T* p_00 = p_in + off_00;
+      T* p_01 = p_in + off_01;
+      T* p_02 = p_in + off_02;
...
+      T* p_33 = p_in + off_33;
+
+      T* p_00_row = p_in + off_00_row;
+      T* p_01_row = p_in + off_01_row;
+      T* p_02_row = p_in + off_02_row;
+      T* p_03_row = p_in + off_03_row;
+      T* p_10_row = p_in + off_10_row;
+      T* p_11_row = p_in + off_11_row;
+      T* p_12_row = p_in + off_12_row;
+      T* p_13_row = p_in + off_13_row;
+      T* p_20_row = p_in + off_20_row;
+      T* p_21_row = p_in + off_21_row;
+      T* p_22_row = p_in + off_22_row;
+      T* p_23_row = p_in + off_23_row;
+      T* p_30_row = p_in + off_30_row;
+      T* p_31_row = p_in + off_31_row;
+      T* p_32_row = p_in + off_32_row;
+      T* p_33_row = p_in + off_33_row;
+
+      T z00_00 =  *p_00;
+      T z10_00 = *(p_00_row);
+      T z01_00 = *(p_00               + 1);
...
+
+      // vec_01_z3 = ss_simd::shiftr<fxp_shift>(vec_01_z3);
+      // vec_23_z3 = ss_simd::shiftr<fxp_shift>(vec_23_z3);
+
...
+  // multiply high half-width (or even half-width elements).
+  static simd_type mulh(simd_type const& v1, simd_type const& v2)
+  { return spu_mule((__vector unsigned short)v1, (__vector unsigned short)v2); }
+
+  // multiply low half-width (or odd half-width elements).
+  static simd_type mull(simd_type const& v1, simd_type const& v2)
+  { return spu_mulo((__vector unsigned short)v1, (__vector unsigned short)v2); }
+
+  static simd_type band(simd_type const& v1, simd_type const& v2)
+  { return spu_and(v1, v2); }
+
...
+#if 0
+    return VSIP_IMPL_SPU_LITERAL(simd_type, value, 0.f, 0.f, 0.f);
+#endif
+  }
+
+  static simd_type load_scalar_all(value_type value)
...
+
+//  static simd_type min(simd_type const& v1, simd_type const& v2)
+//  { return spu_min(v1, v2); }
+
+//  static simd_type max(simd_type const& v1, simd_type const& v2)
+//  { return spu_max(v1, v2); }
+
+  // TODO: PERHAPS bool_simd_type should be == simd_type?
+  static simd_type band(bool_simd_type const& v1, simd_type const& v2)
...
+  double refmax1 = maxval(magsq(view_cast<double>(v1)), idx);
+  double refmax2 = maxval(magsq(view_cast<double>(v2)), idx);
...
+    ite(magsq(view_cast<double>(v1 - v2)) < 1.e-20,
+	-201.0,
+	10.0 * log10(magsq(view_cast<double>(v1 - v2))/(2.0*refmax)) ),
+    idx);
   return maxsum;
 }
...
+
+#if 0
+      std::cout << "in 0: " << in_r0 << " " << in_c0 << "   "
+		<< "in 1: " << in_r1 << " " << in_c1 << "   "
+		<< "out 0: " << out_r0 << " " << out_c0 << "   "
+		<< "out size: " << my_r_size << " " << my_c_size
+		<< std::endl;
+      std::cout << "in size: " << (in_r1 - in_r0 + 1) << " " << (in_c1 - in_c0 + 1)
+		<< std::endl;
+#endif
+	
+
...
+          vsip::alg_hint_type a_hint>
+template <typename Block1>
+Pwarp_impl<CoeffT, T, interp_linear, DirT, n_times, a_hint, vsip::impl::Cbe_sdk_tag>::
+Pwarp_impl(
...
+{
+
+// Define which combinations are SIMD optimized.
+
+template <transform_dir T_dir>
+struct Is_pwarp_impl_avail<vsip::impl::Simd_builtin_tag,
+			   float, float, interp_linear, T_dir>
+{
+  static bool const value = true;
+};
+
+template <transform_dir T_dir>
+struct Is_pwarp_impl_avail<vsip::impl::Simd_builtin_tag,
+			   float, unsigned char, interp_linear, T_dir>
+{
+  static bool const value = true;
+};
+
...
+  T* p_out = out_ext.data();
+  stride_type in_stride_0  = in_ext.stride(0);
+  stride_type out_stride_0 = out_ext.stride(0);
+
+  ui_simd_t vec_in_stride_0 = ui_simd::load_scalar_all(in_stride_0);
+  int yet = 0;
+
...
+    apply_proj_w<CoeffT>(P, 0., y, u_base, v_base, w_base);
+
+    simd_t vec_u0_base = simd::add(simd::load_scalar_all(u_base), vec_u_delta_ramp);
+    simd_t vec_v0_base = simd::add(simd::load_scalar_all(v_base), vec_v_delta_ramp);
+    simd_t vec_w0_base = simd::add(simd::load_scalar_all(w_base), vec_w_delta_ramp);
+
+    simd_t vec_w1_base = simd::add(vec_w0_base, vec_w_delta);
+    simd_t vec_u1_base = simd::add(vec_u0_base, vec_u_delta);
+    simd_t vec_v1_base = simd::add(vec_v0_base, vec_v_delta);
...
+      simd_t vec_v3_1_beta = simd::sub(vec_1, vec_v3_beta);
+
+      si_simd_t vec_0_k00= vec_cts(simd::fma(vec_u0_1_beta, vec_v0_1_beta, vec_05), 15);
+      si_simd_t vec_1_k00= vec_cts(simd::fma(vec_u1_1_beta, vec_v1_1_beta, vec_05), 15);
+      si_simd_t vec_2_k00= vec_cts(simd::fma(vec_u2_1_beta, vec_v2_1_beta, vec_05), 15);
+      si_simd_t vec_3_k00= vec_cts(simd::fma(vec_u3_1_beta, vec_v3_1_beta, vec_05), 15);
+      si_simd_t vec_0_k01= vec_cts(simd::fma(vec_u0_beta,   vec_v0_1_beta, vec_05), 15);
+      si_simd_t vec_1_k01= vec_cts(simd::fma(vec_u1_beta,   vec_v1_1_beta, vec_05), 15);
+      si_simd_t vec_2_k01= vec_cts(simd::fma(vec_u2_beta,   vec_v2_1_beta, vec_05), 15);
+      si_simd_t vec_3_k01= vec_cts(simd::fma(vec_u3_beta,   vec_v3_1_beta, vec_05), 15);
+      si_simd_t vec_0_k10= vec_cts(simd::fma(vec_u0_1_beta, vec_v0_beta, vec_05), 15);
+      si_simd_t vec_1_k10= vec_cts(simd::fma(vec_u1_1_beta, vec_v1_beta, vec_05), 15);
+      si_simd_t vec_2_k10= vec_cts(simd::fma(vec_u2_1_beta, vec_v2_beta, vec_05), 15);
+      si_simd_t vec_3_k10= vec_cts(simd::fma(vec_u3_1_beta, vec_v3_beta, vec_05), 15);
+      si_simd_t vec_0_k11= vec_cts(simd::fma(vec_u0_beta,   vec_v0_beta, vec_05), 15);
+      si_simd_t vec_1_k11= vec_cts(simd::fma(vec_u1_beta,   vec_v1_beta, vec_05), 15);
+      si_simd_t vec_2_k11= vec_cts(simd::fma(vec_u2_beta,   vec_v2_beta, vec_05), 15);
+      si_simd_t vec_3_k11= vec_cts(simd::fma(vec_u3_beta,   vec_v3_beta, vec_05), 15);
+
...
+      vec_23_z3 = ss_simd::add(vec_23_z3, vec_z3_base);
+
+      // vec_01_z3 = vec_and(vec_s01_good, vec_01_z3);
+      // vec_23_z3 = vec_and(vec_s23_good, vec_23_z3);
+
...
+
+
+// SIMD Float/float perspective warp
+
+#ifdef VSIP_IMPL_SIMD_ALTIVEC
+template <>
+struct Pwarp<float, float>
+{
+  typedef float T;
+  typedef float CoeffT;
+
...
+
+
+// SIMD float/uchar perspective warp
+
+// Debug version to work out uchar math.  Only processes 4 points at a time.
+
+#if 0
+template <>
+struct Pwarp<float, unsigned char>
+{
+  typedef unsigned char T;
+  typedef float CoeffT;
+
...
+      bool_simd_t vec_good   = ui_simd::band(vec_u_good, vec_v_good);
+
+      __vector __bool short vec_s_good = vec_pack(vec_good, vec_good);
+
+      ui_simd_t vec_u0 = simd::convert_uint(vec_u);
+      ui_simd_t vec_v0 = simd::convert_uint(vec_v);
+
...
+      simd_t vec_v_1_beta = simd::sub(vec_1, vec_v_beta);
+
+      si_simd_t vec_k00_2 = vec_cts(simd::fma(vec_u_1_beta, vec_v_1_beta, vec_05), 15);
+      si_simd_t vec_k01_2 = vec_cts(simd::fma(vec_u_beta,   vec_v_1_beta, vec_05), 15);
+      si_simd_t vec_k10_2 = vec_cts(simd::fma(vec_u_1_beta, vec_v_beta, vec_05), 15);
+      si_simd_t vec_k11_2 = vec_cts(simd::fma(vec_u_beta,   vec_v_beta, vec_05), 15);
+
+      ss_simd_t vec_k00 = vec_pack(vec_k00_2, si_simd::zero());
+      ss_simd_t vec_k01 = vec_pack(vec_k01_2, si_simd::zero());
+      ss_simd_t vec_k10 = vec_pack(vec_k10_2, si_simd::zero());
+      ss_simd_t vec_k11 = vec_pack(vec_k11_2, si_simd::zero());
+
+      ui_simd_t vec_offset = ui_simd::add(
+	ui_simd::mull(vec_v0, vec_in_stride_0), vec_u0);
+
...
+      T z11_3 = *(p_3 + in_stride_0 + 1);
+
+      ss_simd_t vec_z00 = us_simd::load_values(z00_0 << 7, z00_1 << 7, z00_2 << 7, z00_3 << 7);
+      ss_simd_t vec_z10 = us_simd::load_values(z10_0 << 7, z10_1 << 7, z10_2 << 7, z10_3 << 7);
+      ss_simd_t vec_z01 = us_simd::load_values(z01_0 << 7, z01_1 << 7, z01_2 << 7, z01_3 << 7);
+      ss_simd_t vec_z11 = us_simd::load_values(z11_0 << 7, z11_1 << 7, z11_2 << 7, z11_3 << 7);
+
+      ss_simd_t vec_start = ss_simd::load_scalar_all(0x0000);
+      ss_simd_t vec_z0 = vec_madds(vec_k00, vec_z00, vec_start);
+      ss_simd_t vec_z1 = vec_madds(vec_k01, vec_z01, vec_z0);
+      ss_simd_t vec_z2 = vec_madds(vec_k10, vec_z10, vec_z1);
+      ss_simd_t vec_z3 = vec_madds(vec_k11, vec_z11, vec_z2);
+
+      vec_z3 = ss_simd::add(vec_z3, ss_simd::load_scalar_all(0x0040));
+
+      vec_z3 = vec_and(vec_s_good, vec_z3);
+
+      signed short z_0, z_1, z_2, z_3;
+      signed short z_4, z_5, z_6, z_7;
+      ss_simd::extract_all(vec_z3, z_0, z_1, z_2, z_3, z_4, z_5, z_6, z_7);
+
+#if 0
+      float uu = simd::extract(vec_u, 0);
+      float vv = simd::extract(vec_v, 0);
+
+      if (uu >= 0 && uu < u_clip && vv > 0 && vv < v_clip &&
+	  z_0 >> 7 == 254 &&
+	  z00_0 == 255 && z01_0 == 255 && z10_0 == 255 && z11_0 == 255 && !yet)
+      {
+	yet = 1;
+	std::cout << "r, c: " << r << ", " << c << std::endl;
+	std::cout << "vec_u_1_beta[0]: " << simd::extract(vec_u_1_beta, 0) << std::endl;
+	std::cout << "vec_v_1_beta[0]: " << simd::extract(vec_v_1_beta, 0) << std::endl;
+	std::cout << "vec_u_beta[0]: " << simd::extract(vec_u_beta, 0) << std::endl;
+	std::cout << "vec_v_beta[0]: " << simd::extract(vec_v_beta, 0) << std::endl;
+
+	std::cout << "vec_k00[0]: " << us_simd::extract(vec_k00, 0) << std::endl;
+	std::cout << "vec_k01[0]: " << us_simd::extract(vec_k01, 0) << std::endl;
+	std::cout << "vec_k10[0]: " << us_simd::extract(vec_k10, 0) << std::endl;
+	std::cout << "vec_k11[0]: " << us_simd::extract(vec_k11, 0) << std::endl;
+
+	std::cout << "z00_0: " << (int)z00_0 << std::endl;
+	std::cout << "z01_0: " << (int)z01_0 << std::endl;
+	std::cout << "z10_0: " << (int)z10_0 << std::endl;
+	std::cout << "z11_0: " << (int)z11_0 << std::endl;
+	std::cout << "z_0: " << z_0 << std::endl;
+	std::cout << "char z_0: " << (z_0 >> 7) << std::endl;
+      }
+#endif
+      p_out[0] = (unsigned char)(z_0 >> 7);
+      p_out[1] = (unsigned char)(z_1 >> 7);
+      p_out[2] = (unsigned char)(z_2 >> 7);
+      p_out[3] = (unsigned char)(z_3 >> 7);
+      p_out += 4;
+
+      vec_w_base = simd::add(vec_w_base, vec_w_delta);
+      vec_u_base = simd::add(vec_u_base, vec_u_delta);
...
+
+
+// Perspective warp image processing function.
+
+template <typename CoeffT,
+	  typename T,
+	  typename Block1,
...
+
+	T z00 = in.get(v0,   u0);
+	T z10 = in.get(v0+1, u0+0);
+	T z01 = in.get(v0+0, u0+1);
+	T z11 = in.get(v0+1, u0+1);
+
+	AccumT z0 = (AccumT)((1 - u_beta) * z00 + u_beta * z01);
+	AccumT z1 = (AccumT)((1 - u_beta) * z10 + u_beta * z11);
+
...
+  vsip_csl::img::ref_perspective_warp  (P, src, chk1);
+  vsip_csl::img::ref_perspective_warp_2(P, src, chk2);
+
