...
--- ChangeLog	9 Jun 2006 00:52:58 -0000	1.500
+++ ChangeLog	9 Jun 2006 00:55:13 -0000
@@ -1,5 +1,13 @@
...
diff -u -r1.3 cfar.cpp
--- benchmarks/hpec_kernel/cfar.cpp	9 Jun 2006 00:52:58 -0000	1.3
+++ benchmarks/hpec_kernel/cfar.cpp	9 Jun 2006 00:55:13 -0000
@@ -604,6 +604,298 @@
...
===================================================================
RCS file: benchmarks/hpec_kernel/cfar_c.cpp
diff -N benchmarks/hpec_kernel/cfar_c.cpp
--- /dev/null	1 Jan 1970 00:00:00 -0000
+++ benchmarks/hpec_kernel/cfar_c.cpp	9 Jun 2006 00:55:13 -0000
@@ -0,0 +1,754 @@
...
+{
+  char* what() { return "t_cfar_by_vector_c"; }
+
+#if PARALLEL_CFAR
+  typedef Map<Block_dist, Block_dist, Block_dist>  root_map_type;
+  typedef Dense<3, T, row3_type, root_map_type>    root_block_type;
...
+      count[k] = 0;
+
+    impl::Ext_data<Block> ext_cube(cube.block());
+
+    subvector_type cpow_vec = cpow(0, 0, whole_domain);
+    impl::Ext_data<typename subvector_type::block_type>
+      ext_cpow_vec(cpow_vec.block());
+
...
+{
+  char* what() { return "t_cfar_by_vector_csimd"; }
+
+#if PARALLEL_CFAR
+  typedef Map<Block_dist, Block_dist, Block_dist>  root_map_type;
+  typedef Dense<3, T, row3_type, root_map_type>    root_block_type;
...
+
+    impl::Ext_data<Block> ext_cube(cube.block());
+    impl::Ext_data<Block> ext_cpow(cpow.block());
+
+    float* p_cube = ext_cube.data();
