...
--- ChangeLog	4 Apr 2006 02:22:23 -0000	1.428
+++ ChangeLog	10 Apr 2006 18:29:52 -0000
@@ -1,4 +1,21 @@
+2006-04-10  Jules Bergmann  <jules@codesourcery.com>
+
...
diff -u -r1.14 loop.hpp
--- benchmarks/loop.hpp	3 Apr 2006 19:17:15 -0000	1.14
+++ benchmarks/loop.hpp	10 Apr 2006 18:29:52 -0000
@@ -71,9 +71,18 @@
 enum bench_mode
 {
   steady_mode,
...
diff -u -r1.8 main.cpp
--- benchmarks/main.cpp	21 Mar 2006 15:53:09 -0000	1.8
+++ benchmarks/main.cpp	10 Apr 2006 18:29:52 -0000
@@ -89,6 +89,11 @@
...
diff -u -r1.1 mpi_alltoall.cpp
--- benchmarks/mpi_alltoall.cpp	3 Mar 2006 14:30:53 -0000	1.1
+++ benchmarks/mpi_alltoall.cpp	10 Apr 2006 18:29:52 -0000
@@ -37,8 +37,46 @@
 struct Impl_isend;
 struct Impl_isend_x;
...
diff -u -r1.6 expr_serial_evaluator.hpp
--- src/vsip/impl/expr_serial_evaluator.hpp	3 Apr 2006 20:39:29 -0000	1.6
+++ src/vsip/impl/expr_serial_evaluator.hpp	10 Apr 2006 18:29:52 -0000
@@ -120,7 +120,8 @@
...
diff -u -r1.2 fast-transpose.hpp
--- src/vsip/impl/fast-transpose.hpp	3 Apr 2006 20:39:29 -0000	1.2
+++ src/vsip/impl/fast-transpose.hpp	10 Apr 2006 18:29:52 -0000
@@ -14,7 +14,7 @@
   Includes & Macros
 ***********************************************************************/
...
===================================================================
RCS file: /home/cvs/Repository/vpp/tests/plainblock.hpp,v
retrieving revision 1.8
diff -u -r1.8 plainblock.hpp
--- tests/plainblock.hpp	4 Aug 2005 11:53:03 -0000	1.8
+++ tests/plainblock.hpp	10 Apr 2006 18:29:52 -0000
@@ -185,10 +185,6 @@
